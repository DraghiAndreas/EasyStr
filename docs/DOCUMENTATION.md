...
### `EasyIsAlphaChr(const unsigned char chr)`
...
### `EasyCount(const char* string, const char chr)`
Counts the number of occurrences of a specific character in a string.
* **Parameters:**
  * `string`: The string to search in.
  * `chr`: The character to count.
* **Returns:** The total number (`size_t`) of times `chr` appears in `string`.

### `EasyStrCount(const char* string1, const char* string2)`
Counts the number of non-overlapping occurrences of a substring in a string.
* **Parameters:**
  * `string1`: The string to search in.
  * `string2`: The null-terminated substring to count.
* **Returns:** The total number (`size_t`) of times `string2` appears in `string1`.
...
* **Parameters:**
  * `string`: The string to search in.
  * `chr`: The character to find.
* **Returns:** A pointer to the last occurrence of `chr` in `string`, or `NULL` if not found.

### `EasySearchStr(const char* string1, const char* string2)`
Finds the **first** occurrence of a substring in a string.
* **Parameters:**
  * `string1`: The string to search in.
  * `string2`: The null-terminated substring to find.
* **Returns:** A pointer to the beginning of the first occurrence of `string2` in `string1`, or `NULL` if not found.

### `EasyRSearchStr(const char* string1, const char* string2)`
Finds the **last** occurrence of a substring in a string.
* **Parameters:**
  * `string1`: The string to search in.
  * `string2`: The null-terminated substring to find.
* **Returns:** A pointer to the beginning of the last occurrence of `string2` in `string1`, or `NULL` if not found.
